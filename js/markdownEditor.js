            ...
            [{
                    ...
                    data: [{
                        ...
                        },
                        {
                            ...
                            title: "Image/File",
                            /***********************************
                             * TEBPATCH (MDF) @fcasanellas 03/02/2016
                             * #JS001	Canvia la icona de l'adjunt a l'editor
                             * OLDCODE *************************
                            icon: {glyph: 'glyphicon glyphicon-picture', fa: 'fa fa-picture-o', 'fa-3': 'icon-picture'},
                            /***********************************
                             * NEWCODE ************************/
                            icon: {glyph: 'glyphicon glyphicon-paperclip', fa: 'fa fa-paperclip', 'fa-3': 'icon-paper-clip'},
                            /***********************************
                             * END TEBPATCH *******************/
                            callback: function(e) {
                                newFile = "";
